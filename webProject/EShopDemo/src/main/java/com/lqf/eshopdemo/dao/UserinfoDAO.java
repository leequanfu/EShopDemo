...
public interface UserinfoDAO extends JpaDao<Userinfo> {
	 ...
	 *
	 */
	public Set<Userinfo> findUserinfoByBirthdayAfter(Calendar birthday, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Userinfo> findUserinfoByBirthday(java.util.Calendar birthday_1) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByBirthday
	 *
	 */
	public Set<Userinfo> findUserinfoByBirthday(Calendar birthday_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Userinfo> findUserinfoByGender(String gender_1) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByGender
	 *
	 */
	public Set<Userinfo> findUserinfoByGender(String gender_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByPasswordContaining
	 *
	 */
	public Set<Userinfo> findUserinfoByPasswordContaining(String password_1) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByPasswordContaining
	 *
	 */
	public Set<Userinfo> findUserinfoByPasswordContaining(String password_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Userinfo> findUserinfoByUsernameContaining(String username_1) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByUsernameContaining
	 *
	 */
	public Set<Userinfo> findUserinfoByUsernameContaining(String username_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Userinfo> findUserinfoByEmailContaining(String email_1) throws DataAccessException;

	/**
	 * JPQL Query - findUserinfoByEmailContaining
	 *
	 */
	public Set<Userinfo> findUserinfoByEmailContaining(String email_1, int startResult, int maxRows) throws DataAccessException;
