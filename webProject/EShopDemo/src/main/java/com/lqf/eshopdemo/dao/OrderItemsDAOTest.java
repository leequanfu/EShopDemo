...
public class OrderItemsDAOTest {
	 ...
	 *
	 */
	private OrderItemsDAO dataStore;

	/**
	 * Instantiates a new OrderItemsDAOTest.
	 *
	 */
	public OrderItemsDAOTest() {
	}

	/**
	 * Method to test OrderItems domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(OrderItemsDAO dataStore) {
