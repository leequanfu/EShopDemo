...
public class CatalogDAOTest {
	 ...
	 *
	 */
	private CatalogDAO dataStore;

	/**
	 * Instantiates a new CatalogDAOTest.
	 *
	 */
	public CatalogDAOTest() {
	}

	/**
	 * Method to test Catalog domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(CatalogDAO dataStore) {
