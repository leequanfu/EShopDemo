...
public class ProductCatalogDAOTest {
	 ...
	 *
	 */
	private ProductCatalogDAO dataStore;

	/**
	 * Instantiates a new ProductCatalogDAOTest.
	 *
	 */
	public ProductCatalogDAOTest() {
	}

	/**
	 * Method to test ProductCatalog domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(ProductCatalogDAO dataStore) {
