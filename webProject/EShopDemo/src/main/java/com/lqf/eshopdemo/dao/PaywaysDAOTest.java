...
public class PaywaysDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private PaywaysDAO dataStore;

	/**
	 * Instantiates a new PaywaysDAOTest.
	 *
	 */
	public PaywaysDAOTest() {
	}

	/**
	 * Method to test Payways domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Payways() {
		Payways instance = new Payways();
	 ...
	 */
	@Autowired
	public void setDataStore(PaywaysDAO dataStore) {
