...
public class ProductDetailDAOTest {
	 ...
	 *
	 */
	private ProductDetailDAO dataStore;

	/**
	 * Instantiates a new ProductDetailDAOTest.
	 *
	 */
	public ProductDetailDAOTest() {
	}

	/**
	 * Method to test ProductDetail domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(ProductDetailDAO dataStore) {
