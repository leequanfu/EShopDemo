...
public class ProductDetailServiceTest {
	...
	public void deleteProductDetailProductProperties() {
		...
		response = service.deleteProductDetailProductProperties(productdetail_id, related_productproperties_proId, related_productproperties_key);
	...
	public void deleteProductDetailProductCatalogs() {
		...
		ProductDetail response = null;
		response = service.deleteProductDetailProductCatalogs(productdetail_id_1, related_productcatalogs_productId, related_productcatalogs_catalogId);
	...
	public void saveProductDetailOrderItemses() {
		...
		ProductDetail response = null;
		response = service.saveProductDetailOrderItemses(id, related_orderitemses);
	...
	public void deleteProductDetail() {
		...
		service.deleteProductDetail(productdetail);
	}
	...
	public void saveProductDetailProductOffers() {
		...
		ProductDetail response = null;
		response = service.saveProductDetailProductOffers(id_1, related_productoffers);
	...
	public void deleteProductDetailOrderItemses() {
		...
		ProductDetail response = null;
		response = service.deleteProductDetailOrderItemses(productdetail_id_2, related_orderitemses_orderId, related_orderitemses_productId);
	...
	public void saveProductDetail() {
		...
		service.saveProductDetail(productdetail_1);
	}
	...
	public void findProductDetailByPrimaryKey() {
		...
		Integer id_2 = 0;
		ProductDetail response = null;
		response = service.findProductDetailByPrimaryKey(id_2);
	...
	public void deleteProductDetailProductOffers() {
		...
		ProductDetail response = null;
		response = service.deleteProductDetailProductOffers(productdetail_id_3, related_productoffers_proId, related_productoffers_offerId);
	...
	public void saveProductDetailProductProperties() {
		...
		ProductDetail response = null;
		response = service.saveProductDetailProductProperties(id_4, related_productproperties);
	...
	public void saveProductDetailCustomerComments() {
		...
		ProductDetail response = null;
		response = service.saveProductDetailCustomerComments(id_5, related_customercomments);
	...
	public void deleteProductDetailCustomerComments() {
		...
		ProductDetail response = null;
		response = service.deleteProductDetailCustomerComments(productdetail_id_4, related_customercomments_proId, related_customercomments_userId);
